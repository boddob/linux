...
static struct clk_lookup apq_clocks_8084_rumi[] = {
	...
	CLK_DUMMY("iface_clk", mdss_ahb_clk.c, "fd900100.qcom,mdss_mdp", OFF),
	CLK_DUMMY("bus_clk", mdss_axi_clk.c, "fd900100.qcom,mdss_mdp", OFF),
	CLK_DUMMY("core_clk_src", mdp_clk_src.c, "fd900100.qcom,mdss_mdp", OFF),
	...
	CLK_DUMMY("lut_clk", mdss_mdp_lut_clk.c, "fd900100.qcom,mdss_mdp", OFF),
	CLK_DUMMY("vsync_clk", mdss_vsync_clk.c, "fd900100.qcom,mdss_mdp", OFF),
...
static struct clk_lookup apq_clocks_8084[] = {
	...
	CLK_LOOKUP("iface_clk", mdss_ahb_clk.c, "fd900100.qcom,mdss_mdp"),
	CLK_LOOKUP("bus_clk", mdss_axi_clk.c, "fd900100.qcom,mdss_mdp"),
	CLK_LOOKUP("core_clk_src", mdp_clk_src.c, "fd900100.qcom,mdss_mdp"),
	...
	CLK_LOOKUP("core_clk", mdss_mdp_clk.c, "fd900100.qcom,mdss_mdp"),
	CLK_LOOKUP("lut_clk", mdss_mdp_lut_clk.c, "fd900100.qcom,mdss_mdp"),
	CLK_LOOKUP("vsync_clk", mdss_vsync_clk.c, "fd900100.qcom,mdss_mdp"),
