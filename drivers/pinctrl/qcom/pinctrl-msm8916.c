...
static const struct msm_pingroup msm8916_groups[] = {
	...
	PINGROUP(4, blsp_spi2, blsp_uart2, blsp_uim2, blsp1_spi,
		 qdss_tracectl_b, NA, atest_combodac, NA, NA),
	...
	PINGROUP(45, wcss_fm, ext_lpass, qdss_tracectl_a, NA, atest_combodac,
		 NA, NA, NA, NA),
	PINGROUP(46, wcss_fm, qdss_traceclk_a, NA, atest_combodac, NA, NA, NA,
		 NA, NA),
	PINGROUP(47, wcss_bt, dbg_out, qdss_tracedata_a, NA, atest_combodac, NA,
		 NA, NA, NA),
	PINGROUP(48, wcss_bt, qdss_tracedata_a, NA, atest_combodac, NA, NA, NA,
		 NA, NA),
