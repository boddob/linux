...
const struct mdp5_cfg_hw msm8x74v1_config = {
	...
	.lm = {
		...
		.instances = {
				{ .id = 0, .pp = 0, .dspp = 0, .caps = 0, },
				{ .id = 1, .pp = 1, .dspp = 1, .caps = 0, },
				{ .id = 2, .pp = 2, .dspp = 2, .caps = 0, },
				{ .id = 3, .pp = -1, .dspp = -1, .caps = MDP_LM_CAP_WB },
				{ .id = 4, .pp = -1, .dspp = -1, .caps = MDP_LM_CAP_WB },
			     },
		.nb_stages = 5,
	},
	.dspp = {
...
const struct mdp5_cfg_hw msm8x96_config = {
	...
	.lm = {
		...
		.instances = {
				{ .id = 0, .pp = 0, .dspp = 0, .caps = 0, },
				{ .id = 1, .pp = 1, .dspp = 1, .caps = 0, },
				{ .id = 2, .pp = 2, .dspp = -1, .caps = 0, },
				{ .id = 3, .pp = -1, .dspp = -1, .caps = MDP_LM_CAP_WB },
				{ .id = 4, .pp = -1, .dspp = -1, .caps = MDP_LM_CAP_WB },
				{ .id = 5, .pp = 3, .dspp = -1, .caps = 0 },
			     },
		.nb_stages = 8,
		.max_width = 2560,
		.max_height = 0xFFFF,
