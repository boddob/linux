		...
		uint32_t *major, uint32_t *minor)
{
	...
	*major = MDP5_MDP_HW_VERSION_MAJOR(version);
	*minor = MDP5_MDP_HW_VERSION_MINOR(version);
...
struct msm_kms *mdp5_kms_init(struct platform_device *pdev, struct drm_device *dev)
{
