...
static int mdp5_get_scanoutpos(struct drm_device *dev, int pipe,
				...
				ktime_t *stime, ktime_t *etime)
{
	...
	vactive_end = vsw + vbp + mode->crtc_vdisplay;
...
static int mdp5_get_vblank_timestamp(struct drm_device *dev, int pipe,
			      int *max_error,
...
static u32 mdp5_get_vblank_counter(struct drm_device *dev, int pipe)
{
	struct msm_drm_private *priv = dev->dev_private;
	struct drm_crtc *crtc;
	struct drm_encoder *encoder;
