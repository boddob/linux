				...
				struct msm_dsi_phy_clk_request *clk_req)
{
	...
	timing->hs_halfbyte_en = hb_en = 0;
	timing->hs_halfbyte_en_ckln = hb_en_ckln = 0;
	timing->hs_prep_dly_ckln = pd_ckln = (bit_rate > 100000000) ? 0 : 3;
	timing->hs_prep_dly = pd = (bit_rate > 120000000) ? 0 : 1;
