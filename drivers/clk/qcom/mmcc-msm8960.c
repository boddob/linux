...
static const char *mmcc_pxo_dsi2_dsi1[] = {
	"pxo",
	"dsi2pll",
	"dsi1pll",
};

static struct freq_tbl clk_tbl_dsi1[] = {
...
static struct freq_tbl clk_tbl_dsi2[] = {
	{  .src = P_DSI2_PLL_DSICLK, .pre_div = 1 },
	{ }
};
...
static const char *mmcc_pxo_dsi1_dsi2_byte[] = {
	"pxo",
	"dsi1pllbyte",
	"dsi2pllbyte",
};

static struct freq_tbl clk_tbl_dsi1_byte[] = {
	{  .src = P_DSI1_PLL_BYTECLK, .pre_div = 1 },
	{ }
};
...
static struct freq_tbl clk_tbl_dsi2_byte[] = {
	{  .src = P_DSI2_PLL_BYTECLK, .pre_div = 1 },
	{ }
};
...
static struct freq_tbl clk_tbl_dsi1_esc[] = {
	{  .src = P_DSI1_PLL_BYTECLK, .pre_div = 9 },
	{ }
};
